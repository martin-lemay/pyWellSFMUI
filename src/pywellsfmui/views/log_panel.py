...
_LEVEL_COLORS = {
    MessageLevel.DEBUG: "gray",
    MessageLevel.INFO: "inherit",
    MessageLevel.WARNING: "orange",
    MessageLevel.ERROR: "red",
}

_LEVEL_ORDER = [MessageLevel.DEBUG, MessageLevel.INFO, MessageLevel.WARNING, MessageLevel.ERROR]
